...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-screen px-section py-24 md:py-32"
    >
      <div className="max-w-container-lg mx-auto min-h-[calc(100vh-12rem)] md:min-h-[calc(100vh-16rem)] flex flex-col justify-between">
        ...
        >
          <Button
            ...
            className="uppercase tracking-wider text-sm sm:text-base md:text-lg px-6 sm:px-7 md:px-8 py-4 sm:py-5 md:py-6 gap-2 md:gap-3"
          >
